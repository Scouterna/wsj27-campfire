...
// belongs to. This one proves a real browser reaches the application the journey screens
// are composed into – which, signed out, is the session gate showing the sign-in screen.
