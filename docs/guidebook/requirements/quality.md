...
| Privacy         | The register carries phone numbers, diets, allergies, and health notes, much of it about minors. Who may see what is decided by the back-end, not by the client, and a person outside the caller's scope is indistinguishable from a person who does not exist. |
