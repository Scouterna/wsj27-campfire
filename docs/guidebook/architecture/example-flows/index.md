...
Sign in is the flow every other one stands on: nothing in Campfire is useful without a session, and who is signed in decides what the list of participants answers. Show participants is the first feature, and the one every module that fetches anything is built to look like.
